              ...
              builder: (context, snapshot) {
                ...
                final activities =
                    snapshot.data!.docs.map((doc) {
                      ...
                      return {'data': data, 'date': date ?? DateTime.now()};
                    }).toList();
                ...
                return NotificationListener<ScrollNotification>(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isDeletedRecord =
                          data['action'] == 'deleted_record'; // ✅
                      ...
                      final bool isRescheduled = data['isRescheduled'] == true;
                      ...
                      return Column(
                        ...
                        children: [
                            ...
                            onTap: () {
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder:
                                      (_) =>
                                          ClientDetailsScreen(clientName: name),
                                ),
                              );
                            },
                            child: Padding(
                                        ...
                                        if (isDeletedRecord) ...[
                                          ...
                                          if (scheduledAt != null)
                                            Padding(
                                              ...
                                              child: Text(
                                                'Запис на ${DateFormat('HH:mm, dd.MM.yyyy').format(scheduledAt is Timestamp ? scheduledAt.toDate() : DateTime.tryParse(scheduledAt) ?? DateTime.now())}',
                                                style: const TextStyle(
                                                  fontSize: 14,
                                                  color: Color.fromARGB(
                                                    255,
                          ...
                          if (index == activities.length ||
                              !_isSameDay(
                                date,
                                activities[index]['date'] as DateTime,
                              ))
